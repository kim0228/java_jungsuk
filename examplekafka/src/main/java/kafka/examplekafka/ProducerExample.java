...
public class ProducerExample {
	...
	public static void main(String[] args) throws IOException {
		Document doc = (Document)Jsoup.connect("https://finance.naver.com/marketindex/exchangeDetail.nhn?marketindexCd=FX_USDKRW").get();
		Element test = doc.select(".tbl_calculator").get(0);
		Elements test2 = test.select("tbody > tr");
